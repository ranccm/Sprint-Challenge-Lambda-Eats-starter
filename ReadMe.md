...
react's 'useRouteMatch' hook lets you add nested routes to your application such that you can change a single parameter in the URL without having to change the whole thing. 

2. How would you explain form validation to someone who has never programmed before?

 you can trust user input to be garabage- therfor you have to take steps to 'sanatize' it and make sure that the rules of the form is followed.    

3. In 1-2 sentences, define end to end testing. 

end to end testing looks at the entire user experience from end to end. end to end testing asks 'can a suer accomplish an action?'
